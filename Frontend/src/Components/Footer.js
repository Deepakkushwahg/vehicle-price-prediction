            ...
            <div id="marginwala">
                ...
                <div id="rightfooter">
                    <div>
                        ...
                        <a href="https://play.google.com/store/apps?utm_source=apac_med&utm_medium=hasem&utm_content=Feb0221&utm_campaign=Evergreen&pcampaignid=MKT-EDR-apac-in-1003227-med-hasem-ap-Evergreen-Feb0221-Text_Search_BKWS-BKWS%7cONSEM_kwid_43700065205026376_creativeid_535350509651_device_c&gclid=Cj0KCQiAveebBhD_ARIsAFaAvrElwkDXns3t26zEydm0q-n-_Vq8qgyHnkQ7wm3OcJkaxxGfw56kTDcaAjd_EALw_wcB&gclsrc=aw.ds"><img id="footplay" src={playstore} alt='playstore.png' /></a>
                        <a href="https://www.apple.com/in/app-store/"><img id="footplay" src={ios} alt='ios.png' /></a>
                    </div>
                    <br></br>
                    <div id="logosfoot">
                        <span id="followus">Follow Us :  </span>
                        <a href="https://www.instagram.com/"><img id="footerlogo" src={insta} alt='insta.png' /></a>
                        <a href="https://www.facebook.com/"><img id="footerlogo" src={facebook} alt='facebook.png'/></a>
                        <a href="https://twitter.com/"><img id="footerlogo" src={twitter} alt='twitter.png'/></a>
                        <a href="https://www.linkedin.com/"><img id="footerlogo" src={linkedin} alt='linkedin.png'/></a>
                    </div>
                </div>
            </div>
        </div>
